                ...
                <div class="panel-body">
                    ...
                    <form data-parsley-validate class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('pan') ? ' has-error' : '' }}">
                            <label for="pan" class="col-md-4 control-label">PAN Number <br><small><i>(Optional)</i></small></label>
                            <div class="col-md-6">
                                <input id="pan" type="text"   data-parsley-pattern="/^([a-zA-Z]){5}([0-9]){4}([a-zA-Z]){1}?$/" style="text-transform: uppercase;" class="form-control" name="pan" value="{{ old('pan') }}" maxlength="10" data-parsley-pattern-message="*Invalid PAN Number" placeholder="PAN Number (Optional)">
                                @if ($errors->has('pan'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('aadhar') ? ' has-error' : '' }}">
                            <label for="aadhar" class="col-md-4 control-label">Aadhar Number <br><small><i>(Optional)</i></small></label>
                            <div class="col-md-6">
                                <input id="aadhar" data-parsley-type="digits" minlength="12"   style="text-transform: uppercase;" class="form-control" name="aadhar" value="{{ old('aadhar') }}" maxlength="12" data-parsley-length-message="Aadhar number should be 12 digits"  placeholder="Aadhar Number (Optional)">
