                   ...
                   <form data-parsley-validate class="form-horizontal" role="form" method="POST" action="{{ route('clinics.store') }}">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('clinictype') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select required="" data-parsley-required-message="*Clinic Type is required" name="clinictype" id="clinictype" class="js-example-basic-single form-control">
                                    <option value="" selected="selected">Select a Clinic Type</option>
                                    @foreach($clinictypes as $clinictype)
                                        <option value="{{$clinictype->id}}" >{{$clinictype->clinictype}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select required="" data-parsley-required-message="*Please Select a State" name="state" id="state" maxlength="50" class="js-example-basic-single form-control">
                        ...
                        <div class="form-group{{ $errors->has('phoneprimary') ? ' has-error' : '' }}">
                            <label for="phoneprimary" class="col-md-4 control-label">Primary Phone (Mobile){{-- <br><small><i>(For Landlines,prefix STD code without the leading 0, eg: 2266990077)</i></small> --}}</label>
                                <div class="col-md-6">
                                    <input event.preventDefault(); id="phoneprimary" required="" data-parsley-type="digits" class="form-control" name="phoneprimary" value="{{ old('phoneprimary') }}" data-parsley-pattern="(7|8|9)\d{9}"  placeholder="Primary Phone" minlength="10" maxlength="10" data-parsley-required-message="*Clinic Phone Number is required" data-parsley-pattern-message="*Invalid Mobile Number">
                        ...
                        <div class="form-group{{ $errors->has('phonealternate') ? ' has-error' : '' }}">
                            <label for="phonealternate" class="col-md-4 control-label">Alternate Phone (Optional)</label>
                                <div class="col-md-6">
                                    <input id="phonealternate" data-parsley-type="digits" class="form-control" name="phonealternate" value="{{ old('phonealternate') }}"   placeholder="Alternate Phone (Optional)"  minlength="10" maxlength="10" >
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">Clinic/Hospital E-Mail (Optional)</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
                            <label for="website" class="col-md-4 control-label">Clinic/Hospital Website (Optional)</label>
                                <div class="col-md-6">
