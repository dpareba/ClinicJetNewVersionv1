    ...
    try{
        event(new Registered($user = $this->create($request->all())));
            ...
            try {
                ...
                //return $e->getMessage();
                return view('errors.exceptionerror')->withExcepterr($e->getMessage())->withErrormessage('User Account Activation/Email Verification mail sending failed.Registration could not be completed at this time.Please try again.');
            }
            try {

                Mail::to('admin@clinicjet.com')->send(new UserActivation($user));
                
            } catch (\Exception $e) {
                
                //return $e->getMessage();
                return view('errors.exceptionerror')->withExcepterr($e->getMessage())->withErrormessage('Admin Account Activation mail sending failed.Registration could not be completed at this time.Please try again.');
            }
